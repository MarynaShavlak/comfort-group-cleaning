    ...
    function createCircularSlider(config) {
        ...
        function handleNameClick(e) {
            ...
            if (nameEl.tagName !== 'LI') return;
                 ...
                 const swipeCount = calculateSwipeCount(chosenMemberSlideIndex);
                 console.log('swipeCount: ', swipeCount);
                 const direction = swipeCount < 0 ? -1: 1;
                 const moves  = swipeCount < 0 ? swipeCount * -1 :  swipeCount;
                 console.log('moves: ', moves);
                 console.log('direction : ', direction );
                //  changeSlide(direction);
        //    for (let index = moves; index <= moves; index--) {
        //     changeSlide(direction);
        ...
        function calculateSwipeCount(chosenMemberSlideIndex) {
            if (chosenMemberSlideIndex - 2 > 3) {
                return 2;
            } else if (chosenMemberSlideIndex - 2 < 0) {
                return 1;
            } else if (chosenMemberSlideIndex - 2 === 3) {
                return 3;
            } else {
                return -(chosenMemberSlideIndex - 2);
            }
        }
